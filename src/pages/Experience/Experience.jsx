...
const experienceList = [
  ...
  {
    pargrah: `כיום אני מטפל בקליניקה פרטית בצפון תל אביב. מתמחה, שנה שלישית, בהתמחות קלינית בקליניקה של בית ספר לפסיכולוגיה של אוניברסיטת רייכמן. <br /><br />בנוסף, מרצה במכינת "אשנב" - מכינה שפועלת למען שילוב מתמודדי נפש בקהילה.
    `,
  },
];
